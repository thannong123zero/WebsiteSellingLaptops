...
{
    public class AddCartHandler : IRequestHandler<AddCartRequest, CartViewModel>
    {
        ...
        public AddCartHandler(ICartCommandRepository cartCommandRepository,
        ...
        public Task<CartViewModel> Handle(AddCartRequest request, CancellationToken cancellationToken)
        {
